...
export class  $name1733278815897 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "image_product" ("id" uniqueidentifier NOT NULL CONSTRAINT "DF_e6a9e829e17fc47fc17d695af8e" DEFAULT NEWSEQUENTIALID(), "createdAt" datetime2 NOT NULL CONSTRAINT "DF_79a664dfae7e019450074fadf7d" DEFAULT getdate(), "updatedAt" datetime2 NOT NULL CONSTRAINT "DF_5dba2da21c7a47755adb1579ec0" DEFAULT getdate(), "imageUrl" nvarchar(255) NOT NULL, "productId" uniqueidentifier, CONSTRAINT "PK_e6a9e829e17fc47fc17d695af8e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "discount" ("id" uniqueidentifier NOT NULL CONSTRAINT "DF_d05d8712e429673e459e7f1cddb" DEFAULT NEWSEQUENTIALID(), "createdAt" datetime2 NOT NULL CONSTRAINT "DF_8ea3dc26dc8c9d871f83025c599" DEFAULT getdate(), "updatedAt" datetime2 NOT NULL CONSTRAINT "DF_458c3adaa29baac75ec954e079a" DEFAULT getdate(), "discountCode" nvarchar(255), "discountPercentage" int, "description" nvarchar(255), "amountDiscount" int, "startDate" datetime, "endDate" datetime, "points_required" int, "isActive" bit, CONSTRAINT "PK_d05d8712e429673e459e7f1cddb" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "product_discounts_discount" ("productId" uniqueidentifier NOT NULL, "discountId" uniqueidentifier NOT NULL, CONSTRAINT "PK_077f481076e25b11437259b62d2" PRIMARY KEY ("productId", "discountId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_4724c7a7c65a0a2c45a1c00cc0" ON "product_discounts_discount" ("productId") `);
        await queryRunner.query(`CREATE INDEX "IDX_be7c9f4c0d0d68333b1d75045d" ON "product_discounts_discount" ("discountId") `);
        await queryRunner.query(`ALTER TABLE "image_product" ADD CONSTRAINT "FK_46730a20b58d86123a5bedada8d" FOREIGN KEY ("productId") REFERENCES "product"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "review" ADD CONSTRAINT "FK_72d02541ae9b6fc2fc2c57e745a" FOREIGN KEY ("productVariantId") REFERENCES "product_variant"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "product" ADD CONSTRAINT "FK_4346e4adb741e80f3711ee09ba4" FOREIGN KEY ("supplierId") REFERENCES "supplier"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "product_discounts_discount" ADD CONSTRAINT "FK_4724c7a7c65a0a2c45a1c00cc01" FOREIGN KEY ("productId") REFERENCES "product"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "product_discounts_discount" ADD CONSTRAINT "FK_be7c9f4c0d0d68333b1d75045d3" FOREIGN KEY ("discountId") REFERENCES "discount"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "product_discounts_discount" DROP CONSTRAINT "FK_be7c9f4c0d0d68333b1d75045d3"`);
        await queryRunner.query(`ALTER TABLE "product_discounts_discount" DROP CONSTRAINT "FK_4724c7a7c65a0a2c45a1c00cc01"`);
        ...
        await queryRunner.query(`ALTER TABLE "review" DROP CONSTRAINT "FK_72d02541ae9b6fc2fc2c57e745a"`);
        ...
        await queryRunner.query(`ALTER TABLE "image_product" DROP CONSTRAINT "FK_46730a20b58d86123a5bedada8d"`);
        await queryRunner.query(`DROP INDEX "IDX_be7c9f4c0d0d68333b1d75045d" ON "product_discounts_discount"`);
        await queryRunner.query(`DROP INDEX "IDX_4724c7a7c65a0a2c45a1c00cc0" ON "product_discounts_discount"`);
